...
tape( 'the function returns a filled nested array', function test( t ) {
	...
	actual = filled2dBy( [ 1, 3 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [ [ 'beep' ], [ 'beep' ], [ 'beep' ] ];
	actual = filled2dBy( [ 3, 1 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [ [ 1, 1, 1 ], [ 1, 1, 1 ] ];
	actual = filled2dBy( [ 2, 3 ], constantFunction( 1 ) );
	t.deepEqual( actual, expected, 'returns expected value' );
...
tape( 'the function returns an empty outer array if provided a shape having a first element equal to zero', function test( t ) {
	...
	expected = [];
	actual = filled2dBy( [ 0, 1 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [];
	actual = filled2dBy( [ 0, 0 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [];
	actual = filled2dBy( [ 0, 100 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );
...
tape( 'the function returns empty inner arrays if provided a shape having a second element equal to zero', function test( t ) {
	...
	expected = [ [] ];
	actual = filled2dBy( [ 1, 0 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [ [], [] ];
	actual = filled2dBy( [ 2, 0 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );

	expected = [ [], [], [] ];
	actual = filled2dBy( [ 3, 0 ], constantFunction( 'beep' ) );
	t.deepEqual( actual, expected, 'returns expected value' );
...
tape( 'the function supports providing an execution context', function test( t ) {
	...
	actual = filled2dBy( [ 2, 3 ], clbk, ctx );
